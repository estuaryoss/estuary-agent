...
class Command:
    ...
    def __init__(self, cmd_id, json_file):
        self.cmd_id = cmd_id
    ...
    def run_commands(self, commands):
        ...
        self.command_dict['id'] = str(self.cmd_id)
        ...
        self.__io_utils.write_to_file_dict(self.json_file, self.command_dict)

        self.__run_commands(commands=commands)
    ...
    def __run_command(self, command):
        ...
        if platform.system() == "Windows":
            details[command] = self.__cmd_utils.run_cmd_shell_true_to_file_str(str_cmd=command, cmd_id=self.cmd_id)
        else:
            details[command] = self.__cmd_utils.run_cmd_shell_true_to_file_list(list_cmd=[command], cmd_id=self.cmd_id)
