...
class ErrorCodes:
    HTTP_CODE = {
        ...
        ApiCodeConstants.COMMAND_DETACHED_STOP_FAILURE: "Stopping running detached commands failed",
        ApiCodeConstants.GET_FILE_FAILURE_IS_DIR: "Getting %s file failed. It is a directory, not a file.",
        ApiCodeConstants.GET_ENV_VAR_FAILURE: "Getting env var %s from the container failed.",
        ApiCodeConstants.MISSING_PARAMETER_POST: "Body parameter \"%s\" sent in request missing. Please include "
